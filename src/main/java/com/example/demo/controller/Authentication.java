...
public class Authentication {
	...
	public ResponseEntity<?> splitAuthRequest(@RequestBody AuthenticationRequest authenticationRequest) throws Exception {
	...
	public ResponseEntity<?> createAuthenticateToken(String username,String rawpassword)
			throws Exception { 
		try {
